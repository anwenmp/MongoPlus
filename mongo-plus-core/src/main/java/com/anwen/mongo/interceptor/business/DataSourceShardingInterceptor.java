...
public class DataSourceShardingInterceptor implements Interceptor {
    ...
    public void beforeExecute(ExecuteMethodEnum executeMethodEnum, Object[] source,
        ...
        if (shardingStrategy != null) {
            String shardingDsName = shardingStrategy.sharding(dsNameList, executeMethodEnum, source);
        ...
        // 去重并选择负载均衡后的数据源
        String dsName = dataSourceShardingHandler.loadBalance(dsNameList.stream().distinct().collect(Collectors.toList()));
