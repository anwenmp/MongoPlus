...
import com.anwen.mongo.proxy.AdvancedProxy;
...
public class AdvancedInterceptorChain {
    ...
    /**
     * 获取所有拦截器
     * @return {@link java.util.List<com.anwen.mongo.interceptor.AdvancedInterceptor>}
     * @author anwen
     */
     ...
     * 根据断言获取拦截器
     * @param predicate 断言
     * @return {@link com.anwen.mongo.interceptor.Interceptor}
     * @author anwen
     */
