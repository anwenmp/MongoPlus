...
public interface Logic<T, Children> extends
     ...
     * @author anwen
     */
    default Children combine(boolean condition, SFunction<QueryChainWrapper<T,?>,QueryChainWrapper<T,?>> function) {
     ...
     * @author anwen
     */
    default Children combine(SFunction<QueryChainWrapper<T,?>,QueryChainWrapper<T,?>> function) {
     ...
     * @author anwen
     */
    default Children combine(QueryChainWrapper<?,?> queryChainWrapper) {
     ...
     * @author anwen
     */
    default Children combine(boolean condition,QueryChainWrapper<?,?> queryChainWrapper) {
        return condition ? combine(queryChainWrapper) : typeThis();
    }
