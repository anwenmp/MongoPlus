...
public interface ElemMatch<T, Children> extends BaseQueryCondition<T, Children> {
    ...
    default Children elemMatch(boolean condition, SFunction<T,Object> column ,
        ...
        return condition ? elemMatch(column, queryWrapper) : typeThis();
    }
     ...
     * @author JiaChaoYang
     */
    default Children elemMatch(SFunction<T,Object> column , Wrapper<?> queryWrapper) {
        return addCondition(getBaseCondition(column,queryWrapper));
    }
     ...
     * @author JiaChaoYang
     */
    default Children elemMatch(boolean condition,String column , Wrapper<?> queryWrapper) {
        return condition ? elemMatch(column, queryWrapper) : typeThis();
    }
     ...
     * @author JiaChaoYang
     */
    default Children elemMatch(String column , Wrapper<?> queryWrapper) {
        return addCondition(getBaseCondition(column,queryWrapper));
    }
